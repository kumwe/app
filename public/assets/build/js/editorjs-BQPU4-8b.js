//#region node_modules/@editorjs/editorjs/dist/editorjs.mjs
(function() {
	"use strict";
	try {
...
var S = Ie.bind(window, !1);
var X = Ie.bind(window, !0);
function le(n) {
...
function ut(n, ...e) {
	...
	const t = e.shift();
	if (D(n) && D(t)) for (const o in t) D(t[o]) ? (n[o] || Object.assign(n, { [o]: {} }), ut(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
	return ut(n, ...e);
}
function vt(n) {
	const e = ti();
	...
	*/
	static getDeepestNode(e, t = !1) {
		...
		if (e && e.nodeType === Node.ELEMENT_NODE && e[o]) {
			let s = e[o];
			if (u.isSingleTag(s) && !u.isNativeInput(s) && !u.isLineBreakTag(s)) if (s[i]) s = s[i];
...
function li(n) {
	const e = window.getComputedStyle(n), t = parseFloat(e.fontSize), o = parseFloat(e.lineHeight) || t * 1.2, i = parseFloat(e.paddingTop), s = parseFloat(e.borderTopWidth), r = parseFloat(e.marginTop), a = t * .8, l = (o - t) / 2;
	return r + s + i + l + a;
}
function Do(n) {
...
function Bo(n, e, t) {
	...
	return A(o) ? o(n, t) : te(o) ? { [o]: n } : (o !== void 0 && S("Conversion «import» property must be a string or function. String means key of tool data to import. Function accepts a imported string and return composed tool data."), {});
}
...
var R = class R extends Oe {
	...
	*/
	constructor({ id: e = ni(), data: t, tool: o, readOnly: i, tunesData: s }, r) {
	...
	*/
	async exportDataAsString() {
		return fi(await this.data, this.tool.conversionConfig);
	}
	/**
...
var gi = class extends E {
	constructor() {
		super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, s, r, a) => {
			return new J(this.Editor.BlockManager.insert({
				id: a,
				tool: e,
				data: t,
				index: i,
			...
			return new R({
				tool: this.Editor.Tools.blockTools.get(e),
				api: this.Editor.API,
				readOnly: !0,
				data: {},
				tunesData: {}
			...
			return new J(await i.update(s, t, o));
			...
			if (c && d) return new J(await i.convert(r, t, o));
			else {
				const g = [c ? !1 : je(r.name), d ? !1 : je(t)].filter(Boolean).join(" and ");
...
var kt = class kt extends E {
	...
	*/
	getMethodsForTool(e, t) {
		return Object.assign(this.methods, { t: (o) => z.t(kt.getNamespace(e, t), o) });
	}
};
var ki = class extends E {
	...
	*/
	getMethodsForTool(e, t) {
		return Object.assign(this.methods, { i18n: this.Editor.I18nAPI.getMethodsForTool(e, t) });
	}
};
						...
						if (l.message) {
							...
							switch (l.type) {
								...
								case "prompt":
									c = s.prompt(l);
									break;
								default: c = s.alert(l), window.setTimeout(function() {
									c.remove();
								}, d);
							}
...
(function(n, e) {
	(function(t, o) {
		...
		function t(h) {
			var p = h.tags;
			if (!Object.keys(p).map(function(v) {
				return typeof p[v];
			}).every(function(v) {
		...
		t.prototype.clean = function(h) {
			...
			if (f) do {
				...
				var T = !!p.parentNode, M = i(p) && i(f) && T, q = f.nodeName.toLowerCase(), F = l(this.config, q, f);
				if (v && O || c(f, F) || !this.config.keepNestedBlockElements && M) {
...
var Pi = class extends E {
	...
	*/
	save() {
		...
		return this.Editor.ReadOnly.isEnabled ? (X(e, "warn"), Promise.reject(/* @__PURE__ */ new Error(e))) : this.Editor.Saver.save();
	}
};
...
var Ri = class extends E {
	...
	*/
	get methods() {
		return { getBlockTools: () => Array.from(this.Editor.Tools.blockTools.values()) };
	}
};
			...
			function(t, o, i) {
				...
				class s {
					...
					show(a, l, c) {
						...
						if (d.hidingDelay && (this.hidingDelay = d.hidingDelay), this.nodes.content.innerHTML = "", typeof l == "string") this.nodes.content.appendChild(document.createTextNode(l));
						else {
	...
	*/
	constructor(e) {
		this.iterator = null, this.activated = !1, this.flipCallbacks = [], this.onKeyDown = (t) => {
			if (!(!this.isEventReadyForHandling(t) || t.shiftKey === !0)) switch (ce.usedKeys.includes(t.keyCode) && t.preventDefault(), t.keyCode) {
				case y.TAB:
	...
	handleTabPress(e) {
		switch (e.shiftKey ? ke.directions.LEFT : ke.directions.RIGHT) {
			case ke.directions.RIGHT:
				this.flipRight();
				break;
			case ke.directions.LEFT: this.flipLeft();
		}
	}
	/**
...
var re = class extends xt {
	...
	*/
	make(e, t) {
		var s, r;
		const o = (t == null ? void 0 : t.wrapperTag) || "div", i = u.make(o, L.container, { type: o === "button" ? "button" : void 0 });
		return e.name && (i.dataset.itemName = e.name), this.nodes.icon = u.make("div", [L.icon, L.iconTool], { innerHTML: e.icon || Qi }), i.appendChild(this.nodes.icon), e.title !== void 0 && i.appendChild(u.make("div", L.title, { innerHTML: e.title || "" })), e.secondaryLabel && i.appendChild(u.make("div", L.secondaryTitle, { textContent: e.secondaryLabel })), this.hasChildren && i.appendChild(u.make("div", [L.icon, L.iconChevronRight], { innerHTML: qi })), this.isActive && i.classList.add(L.active), e.isDisabled && i.classList.add(L.disabled), e.hint !== void 0 && ((s = t == null ? void 0 : t.hint) == null ? void 0 : s.enabled) !== !1 && this.addHint(i, {
			...e.hint,
...
var Se = class extends xt {
	...
	*/
	constructor(e, t) {
		var o, i;
		super(e), this.nodes = { root: u.make("div", So.root) }, this.nodes.root.appendChild(e.element), e.name && (this.nodes.root.dataset.itemName = e.name), e.hint !== void 0 && ((o = t == null ? void 0 : t.hint) == null ? void 0 : o.enabled) !== !1 && this.addHint(this.nodes.root, {
			...e.hint,
...
var Jo = class extends Oe {
	...
	*/
	constructor(e, t = {}) {
		super(), this.params = e, this.itemsRenderParams = t, this.listeners = new _e(), this.messages = {
			...
			...this.messages,
			...e.messages
		}), this.nodes = {}, this.nodes.popoverContainer = u.make("div", [P.popoverContainer]), this.nodes.nothingFoundMessage = u.make("div", [P.nothingFoundMessage], { textContent: this.messages.nothingFound }), this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage), this.nodes.items = u.make("div", [P.items]), this.items.forEach((o) => {
	...
	*/
	buildItems(e) {
		return e.map((t) => {
			switch (t.type) {
				case _.Separator: return new Qo();
				case _.Html: return new Se(t, this.itemsRenderParams[_.Html]);
				default: return new re(t, this.itemsRenderParams[_.Default]);
			}
		});
	}
	/**
...
var ls = class extends Oe {
	...
	*/
	constructor({ items: e, placeholder: t }) {
		...
		const o = u.make("div", rt.icon, { innerHTML: os });
	...
	*/
	constructor(e, t) {
		super(e, t), this.nestingLevel = 0, this.nestedPopoverTriggerItem = null, this.previouslyHoveredItem = null, this.scopeElement = document.body, this.hide = () => {
			...
			this.itemsDefault.find((i) => i.isFocused)?.onFocus();
		}, this.onSearch = (o) => {
			var a;
...
var ms = class extends E {
	...
	*/
	async getTunesItems(e, t, o) {
		const i = [];
		o !== void 0 && o.length > 0 && (i.push(...o), i.push({ type: _.Separator }));
		const a = (await Yo(e, Array.from(this.Editor.Tools.blockTools.values()))).reduce((l, c) => (c.toolbox.forEach((d) => {
			l.push({
				icon: d.icon,
		...
		}), i.push({ type: _.Separator })), i.push(...t), i.map((l) => this.resolveTuneAliases(l));
	}
	/**
				...
				return r(l, null, [{
					...
					},
					{
						...
						value: function(c) {
							...
							for (d in this.commands) this.commands[d] !== h[d] && (p = !1);
							var g, f = !0;
...
var Ct = class an extends Oe {
	...
	*/
	constructor({ api: e, tools: t, i18nLabels: o }) {
		...
		}, this.api = e, this.tools = t, this.i18nLabels = o, this.enableShortcuts(), this.nodes = { toolbox: u.make("div", an.CSS.toolbox) }, this.initPopover(), this.api.events.on(Te, this.handleMobileLayoutToggle);
	}
	/**
	...
	*/
	async insertNewBlock(e, t) {
		...
		a.call(ee.APPEND_CALLBACK), this.api.caret.setToBlock(s), this.emit("toolbox-block-added", { block: a }), this.api.toolbar.close();
	}
};
...
var Bs = class extends E {
	...
	*/
	moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
		...
		if (o) i = t.offsetTop + t.offsetHeight;
			...
			const h = li(r), p = parseInt(window.getComputedStyle(this.nodes.plusButton).height, 10);
			i = t.offsetTop + h - p + 8 + c;
		}
	...
	*/
	async make() {
		...
		}), u.append(this.nodes.wrapper, this.nodes.content), u.append(this.nodes.content, this.nodes.actions), this.nodes.plusButton = u.make("div", this.CSS.plusButton, { innerHTML: ts }), u.append(this.nodes.actions, this.nodes.plusButton), this.readOnlyMutableListeners.on(this.nodes.plusButton, "click", () => {
			$e(!0), this.plusButtonClicked();
		}, !1);
		const e = u.make("div");
		e.appendChild(document.createTextNode(z.ui(K.ui.toolbar.toolbox, "Add"))), e.appendChild(u.make("div", this.CSS.plusButtonShortcut, { textContent: "/" })), ze(this.nodes.plusButton, e, { hidingDelay: 400 }), this.nodes.settingsToggler = u.make("span", this.CSS.settingsToggler, { innerHTML: es }), u.append(this.nodes.actions, this.nodes.settingsToggler);
		const t = u.make("div"), o = u.text(z.ui(K.ui.blockTunes.toggler, "Click to tune")), i = await xs("Slash", "/");
		t.appendChild(o), t.appendChild(u.make("div", this.CSS.plusButtonShortcut, { textContent: vt(`CMD + ${i}`) })), ze(this.nodes.settingsToggler, t, { hidingDelay: 400 }), u.append(this.nodes.actions, this.makeToolbox()), u.append(this.nodes.actions, this.Editor.BlockSettings.getElement()), u.append(this.Editor.UI.nodes.wrapper, this.nodes.wrapper);
	}
	/**
...
var Tt = class {
	...
	*/
	constructor({ name: e, constructable: t, config: o, api: i, isDefault: s, isInternal: r = !1, defaultPlaceholder: a }) {
	...
	*/
	constructor({ config: e, eventsDispatcher: t }) {
		super({
			config: e,
			eventsDispatcher: t
		}), this.CSS = { inlineToolbar: "ce-inline-toolbar" }, this.opened = !1, this.popover = null, this.toolbarVerticalMargin = be() ? 20 : 6, this.tools = /* @__PURE__ */ new Map(), window.requestIdleCallback(() => {
			this.make();
		}, { timeout: 2e3 });
	}
	/**
		...
		for (const [o, i] of this.tools) {
			...
			[s].flat().forEach((c) => {
				...
				if (u.isElement(c)) {
					...
					"children" in g && t !== 0 && e.push({ type: _.Separator }), e.push(g), "children" in g && t < this.tools.size - 1 && e.push({ type: _.Separator });
				}
			}), t++;
		}
		return e;
...
_t.isNativeInput = Ss;
function Ss(n) {
	return n && n.tagName ? ["INPUT", "TEXTAREA"].includes(n.tagName) : !1;
}
(function(n) {
...
function _s(n) {
	var e = window.getComputedStyle(n), t = parseFloat(e.fontSize), o = parseFloat(e.lineHeight) || t * 1.2, i = parseFloat(e.paddingTop), s = parseFloat(e.borderTopWidth), r = parseFloat(e.marginTop), a = t * .8, l = (o - t) / 2;
	return r + s + i + l + a;
}
(function(n) {
...
function bt(n, ...e) {
	if (!e.length) return n;
	const t = e.shift();
	if (De(n) && De(t)) for (const o in t) De(t[o]) ? (n[o] === void 0 && Object.assign(n, { [o]: {} }), bt(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
	return bt(n, ...e);
}
function Vs(n, e, t) {
	const o = `«${e}» is deprecated and will be removed in the next major release. Please use the «${t}» instead.`;
...
var Ht = /* @__PURE__ */ Xn(/* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	PromiseQueue: Js,
	beautifyShortcut: Fs,
	cacheable: Ns,
...
function Hr(n, e, t, o, i) {
	...
	c.appendChild(l);
	return (s = c.textContent) !== null && s !== void 0 ? s : "";
}
...
var ra = class extends E {
	...
	*/
	composeBlock({ tool: e, data: t = {}, id: o = void 0, tunes: i = {} }) {
		const s = this.Editor.ReadOnly.isEnabled, a = new R({
			id: o,
			data: t,
			tool: this.Editor.Tools.blockTools.get(e),
			api: this.Editor.API,
	...
	* @returns {Block}
	*/
	insert({ id: e = void 0, tool: t = this.config.defaultBlock, data: o = {}, index: i, needToFocus: s = !0, replace: r = !1, tunes: a = {} } = {}) {
		let l = i;
		...
		return r && this.blockDidMutated(_o, this.getBlockByIndex(l), { index: l }), this._blocks.insert(l, c, r), this.blockDidMutated(Mo, c, { index: l }), s ? this.currentBlockIndex = l : l <= this.currentBlockIndex && this.currentBlockIndex++, c;
	}
	/**
	* Inserts several blocks at once
	*
	...
	*/
	async update(e, t, o) {
		...
		return this._blocks.replace(r, s), this.blockDidMutated(Ao, s, { index: r }), s;
	}
	/**
	...
	*/
	insertDefaultBlockAtIndex(e, t = !1) {
		...
		return this._blocks[e] = o, this.blockDidMutated(Mo, o, { index: e }), t ? this.currentBlockIndex = e : e <= this.currentBlockIndex && this.currentBlockIndex++, o;
	}
	/**
	...
	*/
	async mergeBlocks(e, t) {
		...
		if (e.name === t.name && e.mergeable) {
			...
			o = s;
		} else if (e.mergeable && He(t, "export") && He(e, "import")) o = Bo(Z(await t.exportDataAsString(), e.tool.sanitizeConfig), e.tool.conversionConfig);
	...
	*/
	removeBlock(e, t = !0) {
		return new Promise((o) => {
			...
			this._blocks.remove(i), e.destroy(), this.blockDidMutated(_o, e, { index: i }), this.currentBlockIndex >= i && this.currentBlockIndex--, this.blocks.length ? i === 0 && (this.currentBlockIndex = 0) : (this.unsetCurrentBlock(), t && this.insert()), o();
		});
	}
	/**
	...
	*/
	async convert(e, t, o) {
		...
		let l = Bo(Z(await e.exportDataAsString(), s.sanitizeConfig), s.conversionConfig, s.settings);
	...
	*/
	bindBlockEvents(e) {
		...
		this.readOnlyMutableListeners.on(e.holder, "keydown", (o) => {
			...
			t.dragLeave(o);
		}), e.on("didMutated", (o) => this.blockDidMutated(Ao, o, { index: this.getBlockIndex(o) }));
	}
	/**
	...
	*/
	blockDidMutated(e, t, o) {
		const i = new CustomEvent(e, { detail: {
			target: new J(t),
			...o
		} });
		return this.eventsDispatcher.emit($o, { event: i }), t;
	}
};
	...
	setToBlock(e, t = this.positions.DEFAULT, o = 0) {
		...
		switch (t) {
			...
			case this.positions.END:
				r = e.lastInput;
				break;
			default: r = e.currentInput;
		}
		if (!r) return;
		let a, l = o;
		if (t === this.positions.START) a = u.getDeepestNode(r, !1), l = 0;
		else if (t === this.positions.END) a = u.getDeepestNode(r, !0), l = u.getContentLength(a);
		else {
	...
	extractFragmentFromCaretPosition() {
		...
		if (e.rangeCount) {
			...
			if (t.deleteContents(), o) if (u.isNativeInput(o)) {
				...
				return s.textContent = i.value.substring(i.selectionStart), i.value = r, s;
			} else {
...
var la = class extends E {
	...
	*/
	toggleBlockSelectedState(e = !0) {
		...
		s && (this.lastSelectedBlock.selected !== s.selected ? (s.selected = !0, o.clearCache()) : (this.lastSelectedBlock.selected = !1, o.clearCache()), this.lastSelectedBlock = s, this.Editor.InlineToolbar.close(), s.holder.scrollIntoView({ block: "nearest" }));
	}
	/**
	* Clear saved state
	*
	...
	clear(e) {
		...
		if (o.anyBlockSelected && s > -1 && r > -1 && e && e instanceof KeyboardEvent) switch (e.keyCode) {
			...
			case y.LEFT:
				...
				break;
			default: i.setToBlock(t.blocks[Math.max(s, r)], i.positions.END);
		}
...
var ha = class extends E {
	...
	*/
	redactorChanged(e) {
		this.eventsDispatcher.emit(ft, { mutations: e });
	}
};
		...
		return o.innerHTML = e, this.getNodes(o).map((s) => {
			...
			switch (s.nodeType) {
				case Node.DOCUMENT_FRAGMENT_NODE:
					...
					break;
				case Node.ELEMENT_NODE: r = s, l = !0, this.toolsTags[r.tagName] && (a = this.toolsTags[r.tagName].tool);
			}
		...
		const i = (s, r) => {
			...
			switch (a && u.isFragment(a) && (l = s.pop()), r.nodeType) {
				case Node.ELEMENT_NODE:
					...
					break;
				case Node.TEXT_NODE: return l.appendChild(r), [...s, l];
				default: return [...s, l];
			}
...
var Be = class Be extends E {
	...
	*/
	enableModuleBindings() {
		...
		}, 10), { passive: !0 }), this.listeners.on(document.body, "mouseleave", () => {
			this.processMouseLeave();
		}), this.listeners.on(window, "scroll", dt((t) => {
			this.processScroll(t);
		}, 10), { passive: !0 }), this.listeners.on(document.body, "mouseup", () => {
			this.processMouseUp();
		}, !1);
	}
	/**
	...
	*/
	trySelectNextBlock(e) {
		...
		if (!p && (e > this.stackOfSelected[o - 1] || this.stackOfSelected[o - 1] === void 0)) {
			...
			for (; v <= e; v++) this.addBlockInSelection(v);
			return;
		}
	...
	*/
	async save() {
		...
		try {
			...
			const r = await yt(await Promise.all(i), (a) => t.blockTools.get(a).sanitizeConfig);
...
var Fn = class {
	...
	*/
	async render() {
		...
		if (t === void 0) return [];
		const i = await Yo(t, this.toolsAPI.getBlockTools());
...
var jn = class {
	...
	*/
	make() {
		const e = u.make("div", this.CSS.wrapper), t = is, o = u.make("div", this.CSS.info), i = u.make("div", this.CSS.title, { textContent: this.title }), s = u.make("div", this.CSS.subtitle, { textContent: this.subtitle });
...
var xa = class {
	...
	*/
	getConstructor(e) {
		switch (!0) {
			case e[We.IsInline]: return ka;
			case e[mt.IsTune]: return ya;
			default: return vo;
		}
	}
};
...
var Wn = class extends E {
	...
	assignBlockTunesToBlockTool(e) {
		if (e.enabledBlockTunes !== !1) {
			if (Array.isArray(e.enabledBlockTunes)) {
				e.tunes = new j([...new j(e.enabledBlockTunes.map((o) => [o, this.blockTunes.get(o)])), ...this.blockTunes.internalTools]);
				return;
			}
			if (Array.isArray(this.config.tunes)) {
				e.tunes = new j([...new j(this.config.tunes.map((o) => [o, this.blockTunes.get(o)])), ...this.blockTunes.internalTools]);
				return;
			}
	...
	*/
	validateTools() {
		for (const e in this.config.tools) if (Object.prototype.hasOwnProperty.call(this.config.tools, e)) {
			...
			if (!A(t) && !A(t.class)) throw Error(`Tool «${e}» must be a constructor function or an object with function in the «class» property`);
		}
	}
	/**
	* Unify tools config
	*/
	prepareConfig() {
		const e = {};
		for (const t in this.config.tools) D(this.config.tools[t]) ? e[t] = this.config.tools[t] : e[t] = { class: this.config.tools[t] };
		return e;
	}
};
...
var Ia = class extends E {
	...
	*/
	setIsMobile() {
		...
		e !== this.isMobile && this.eventsDispatcher.emit(Te, { isEnabled: this.isMobile }), this.isMobile = e;
	}
	/**
	...
	*/
	bindReadOnlyInsensitiveListeners() {
		this.listeners.on(document, "selectionchange", this.selectionChangeDebounced), this.listeners.on(window, "resize", this.resizeDebouncer, { passive: !0 }), this.listeners.on(this.nodes.redactor, "mousedown", this.documentTouchedListener, {
			capture: !0,
			passive: !0
	...
	*/
	watchBlockHoveredEvents() {
		...
		this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", dt((t) => {
			...
			this.Editor.BlockSelection.anyBlockSelected || o && e !== o && (e = o, this.eventsDispatcher.emit(ln, { block: this.Editor.BlockManager.getBlockByChildNode(o) }));
		}, 20), { passive: !0 });
	}
	/**
	...
	documentKeydown(e) {
		switch (e.keyCode) {
			...
			case y.ESC:
				...
				break;
			default: this.defaultBehaviour(e);
		}
	}
	/**
...
var _a = class {
	...
	*/
	set configuration(e) {
		var o, i;
		D(e) ? this.config = { ...e } : this.config = { holder: e }, ht(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder ?? (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = Lo.VERBOSE), Zn(this.config.logLevel), ht(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
		const t = {
		...
		this.config.placeholder = this.config.placeholder || !1, this.config.sanitizer = this.config.sanitizer || {
			...
			b: !0,
			a: !0
		}, this.config.hideToolbar = this.config.hideToolbar ? this.config.hideToolbar : !1, this.config.tools = this.config.tools || {}, this.config.i18n = this.config.i18n || {}, this.config.data = this.config.data || { blocks: [] }, this.config.onReady = this.config.onReady || (() => {}), this.config.onChange = this.config.onChange || (() => {}), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (V(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && z.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
	}
	/**
	...
	*/
	validate() {
		...
		if (te(t) && !u.get(t)) throw Error(`element with ID «${t}» is missing. Pass correct holder's ID.`);
		if (t && D(t) && !u.isElement(t)) throw Error("«holder» value must be an Element node");
	}
	/**
	* Initializes modules:
