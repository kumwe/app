const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["js/studio-composition-CNr9-O3S.js","js/reveal-validation-g1jDnck7.js"])))=>i.map(i=>d[i]);
...
if (document.querySelector("[data-studio-composition]") !== null) __vitePreload(async () => {
	const { setupStudioComposition } = await import("./studio-composition-CNr9-O3S.js");
