...
final class CoreExtensionContributions
{
    ...
    private const CAPABILITIES = [
        ...
        'localization.overrides.manage' => 'Change the wording of interface messages for a site or an organization.',
        'navigation.manage' => 'Manage public navigation.',
        'ownership.scope.manage' => 'Widen a resource into a site group, or narrow it back out again.',
    ...
    public static function resourcePolicyDefinitions(): array
    {
        return [
            ...
            self::policy('core.localization.overrides.manage', 'localization.overrides.manage', [
                new ResourcePolicyTarget('message_override'),
            ]),
            ...
            self::policy(
                'core.ownership.scope.manage.shared',
                'ownership.scope.manage',
                [
                    new ResourcePolicyTarget('client'),
                    new ResourcePolicyTarget('person'),
                    new ResourcePolicyTarget('price_list'),
                    new ResourcePolicyTarget('product_service'),
                    new ResourcePolicyTarget('site_group'),
                ],
            ),
            self::policy(
                'core.ownership.scope.manage.installation',
                'ownership.scope.manage',
                [
                    new ResourcePolicyTarget('audit_trail'),
                    new ResourcePolicyTarget('automation_installation'),
            ...
            self::policy(
                'core.reports.consolidated.read',
    ...
    private static function interfaceSurfaces(): array
    {
        ...
        return [
            ...
            SurfaceDefinition::fromArray($owner, [
                'surface' => 'core.administrator.wording',
                'standard' => 'kis-1.0',
                'area' => 'administrator',
                'actor' => 'administrator',
                'intent' => 'collection',
                'resource' => 'message-override',
                'purpose' => 'Change the wording of interface messages for a site or an organization.',
                'pattern' => 'collection-workspace',
                'capabilities' => ['localization.overrides.manage'],
                'states' => ['default', 'empty', 'sparse', 'dense', 'error', 'permission-reduced', 'read-only'],
                'customization' => [
                    ['slot' => 'density', 'scope' => 'user'],
                    ['slot' => 'layout', 'scope' => 'administrator'],
            ...
            SurfaceDefinition::fromArray($owner, [
                'surface' => 'core.administrator.account',
                'standard' => 'kis-1.0',
                'area' => 'administrator',
                'actor' => 'administrator',
                'intent' => 'form',
                'resource' => 'identity',
                'purpose' => 'Replace the authenticated account’s password and retire its previous credentials.',
                'pattern' => 'focused-form',
                'capabilities' => ['administrator.access'],
    ...
    private static function navigation(): array
    {
        return [
            ...
            new AdministratorNavigationDefinition(
                ...
                'core.structure',
                'Wording',
                'Change interface wording without a deployment',
                '/administrator/wording',
                'settings',
                'localization.overrides.manage',
                115,
                'wording terminology language messages translation labels relabel',
                'core.administrator.wording',
            ),
            new AdministratorNavigationDefinition(
