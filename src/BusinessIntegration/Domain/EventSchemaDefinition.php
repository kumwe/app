...
{
    /** @var array<string, mixed> Bounded JSON Schema subset. @since 2.0.0 */
    ...
    /** @return int Schema revision. @since 2.0.0 */
    public function schemaVersion(): int
    {
        return $this->schemaVersion;
    }

    /** @return EventSensitivity Required sensitivity. @since 2.0.0 */
    public function sensitivity(): EventSensitivity
    {
        return $this->sensitivity;
    }

    /** @return array<string, mixed> JSON Schema subset. @since 2.0.0 */
    public function payloadSchema(): array
    {
        return $this->payloadSchema;
    }

    /** @return int Maximum payload bytes. @since 2.0.0 */
    public function maximumBytes(): int
    {
        return $this->maximumBytes;
    }

    /** @return string Type and revision registry key. @since 2.0.0 */
